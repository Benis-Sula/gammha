...
const sections = [
  {
    ...
    label: 'Hero Sections',
    icon: ImageIcon,
    description: 'Edit the hero title, subtitle, and image for every page',
    affects: null,
  },
  {
    ...
    label: 'Team Members',
    icon: Users,
    description: 'Add, edit, or remove team members shown on the About page',
    affects: '/about',
  },
  {
    ...
    label: 'Campaigns',
    icon: Megaphone,
    description: 'Manage advocacy campaigns and their goals',
    affects: '/advocacy',
  },
  {
    href: '/admin/content/conditions',
    label: 'Health Conditions',
    icon: HeartPulse,
    description: 'Update maternal health conditions, signs, and notes',
    affects: '/mental-health',
  },
  {
    href: '/admin/content/warning-signs',
    label: 'Warning Signs',
    icon: TriangleAlert,
    description: 'Manage when-to-seek-help signs on the Mental Health page',
    affects: '/mental-health',
  },
  {
    ...
    icon: BookOpen,
    description: 'Manage resource articles and external organization links',
    affects: '/resources',
  },
  {
    ...
    label: 'Statistics',
    icon: BarChart2,
    description: 'Edit key statistics shown on the homepage and about page',
    affects: null,
  },
  {
    ...
    icon: Heart,
    description: 'Configure preset donation amounts and impact descriptions',
    affects: '/donate',
  },
  {
    ...
    label: 'Focus Areas',
    icon: Home,
    description: 'Edit the four focus area cards shown on the homepage',
    affects: '/',
  },
  {
    ...
    icon: Headphones,
    description: 'Manage phone, WhatsApp, and email support channel details',
    affects: '/support',
  },
  {
    href: '/admin/content/advocacy',
    label: 'Advocacy Content',
    icon: Scale,
    description: 'Edit involvement options and policy advocacy items',
    affects: '/advocacy',
  },
  {
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                {s.affects && (
                  <p className="text-primary text-[10px] mt-1.5 font-medium">
                    → {s.affects}
                  </p>
                )}
              </div>
