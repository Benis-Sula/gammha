      ...
      <AdminPageHeader title="Support Channels" description="Manage phone, WhatsApp, and email support channels."
        action={
          <div className="flex items-center gap-2">
            ...
            <button onClick={openCreate} className="inline-flex items-center gap-2 h-10 px-4 rounded-lg bg-primary text-white text-sm font-medium hover:bg-primary-dark transition-colors cursor-pointer"><Plus className="w-4 h-4" /> Add channel</button>
          </div>
        }
      />
      {showForm && (
